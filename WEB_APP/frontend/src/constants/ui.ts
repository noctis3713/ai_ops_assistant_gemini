...
export const ERROR_STYLES = {
  ...
  // 錯誤程式碼區塊樣式
  CODE_BLOCK: 'bg-red-50 border border-red-200 rounded p-3 text-sm font-mono text-red-800 whitespace-pre-wrap',
} as const;
...
export const WARNING_STYLES = {
  ...
  // 警告程式碼區塊樣式
  CODE_BLOCK: 'bg-amber-50 border border-amber-200 rounded p-3 text-sm font-mono text-amber-800 whitespace-pre-wrap',
  // 警告小標籤樣式
...
export const INFO_STYLES = {
  ...
  // 資訊程式碼區塊樣式
  CODE_BLOCK: 'bg-blue-50 border border-blue-200 rounded p-3 text-sm font-mono text-blue-800 whitespace-pre-wrap',
  // 選中狀態樣式 (用於選中的項目)
...
export const NEUTRAL_STYLES = {
  ...
  // 程式碼區塊樣式 (中性灰色)
  CODE_BLOCK: 'bg-gray-50 border border-gray-200 rounded p-3 text-sm font-mono text-terminal-text-primary whitespace-pre-wrap',
} as const;
