...
from .exceptions import PromptConfigError, PromptTemplateError, PromptLanguageError
...
class PromptManager:
    ...
    def __init__(self, base_dir: Optional[Path] = None, language: str = None):
        ...
        logger.info(f"PromptManager 已初始化", extra={
    ...
    def _load_yaml(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise PromptConfigError(f"YAML 解析失敗: {e}", str(full_path), getattr(e, 'problem_mark', {}).get('line'))
        except Exception as e:
    ...
    def render(self, template_name: str, **kwargs) -> str:
        ...
        try:
            ...
            logger.debug(f"成功渲染模板: {template_path}", extra={
    ...
    def render_react_examples(self, **kwargs) -> str:
        ...
        """
        context = {
            "examples": self.examples.get("react_examples", []),
            **kwargs
        }
